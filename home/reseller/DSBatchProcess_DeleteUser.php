<?php
	...
	DSDebug(0,"DSBatchProcess_DeleteUser ....................................................................................");
	PrintInputGetPost();	
	if($LastError!=""){
...
var Window_OnCloseEvId=parent.dhxLayout.dhxWins.window("popupWindow").attachEvent("onClose",function(){CancelBeforeStart(true)});
	...
	var DataTitle="حذف کاربر";
	var DataName="DSBatchProcess_DeleteUser";
    ...
    var Form1Str=[
		...
		{type: "block", name: "B1", list:[
			{type: "fieldset",width:680,label:"حذف کاربرها", list:[
				{ type: "label"},
				{type: "checkbox", label: "<span style='padding-left:5px'>...ذخیره نسخه پشتیبان از کاربران در فایل</span>", name: "SaveBackup", position: "label-right", checked: true,offsetLeft:400},				
				{ type: "label"},
				{type: "label", label: "<div style='color:red;padding-left:145px'>.این عملیات باعث حذف همه کاربران و تاریخچه های آنها از دلتاسیب می شود</div>"},
				{type: "label", label: "<div style='color:red;padding-left:340px'>.بازیابی کاربران حذف شده، امکان پدیر نیست</div>"},
				{ type: "label"}
			]}
		]},
		...
		{type: "block", name: "B3", list:[
			...
			{type: "button", name:"DoBatch", value: " حذف "+UserCount+" کاربر ", width :280}
		]},
...
function Form1OnBeforeChange(id,value1,value2){
	// dhtmlx.message("id:'"+id+"'     value1:'"+value1+"'      value2="+value2);
	if((id=="SaveBackup")&&(value2)){
		parent.dhtmlx.confirm({
			title: "هشدار",
			type:"confirm-warning",
			ok: "بلی",
			cancel: "خیر",
			text: "هیچ تاریخچه ای از کاربران حذف شده بر روی سرور نگهداری نخواهد شد<br/>آیا مطمئن هستید؟",
			callback: function(Result){
				if(Result)
					Form1.uncheckItem("SaveBackup");
			}
		});
		return false;
	}
			...
			callback: function(Result1){
				if(Result1)
					parent.dhtmlx.confirm({
						...
						ok: "بلی",
						cancel: "خیر",						
						text: "تمامی تاریخچه کاربران حذف خواهد شد<br/>.بازیابی، امکان پدیر نیست<br/>ادامه می دهید؟",
