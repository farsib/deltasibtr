...
if($act=='do'){//request for CHANGE
	...
	exitifnotpermit(0,"Admin.User.Class.VispAccess.Edit");
	...
	if($State==1)
		logdb('Edit',$Table1,$Table1_Id,"$Table2","Register to Visp[$Table2_TextFieldName]");
	else	
		logdb('Edit',$Table1,$Table1_Id,"$Table2","Deleted from Visp[$Table2_TextFieldName]");
	echo "OK";
	exit;
}

exitifnotpermit(0,"Admin.User.Class.VispAccess.List");
