...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="پشتیبان";
	var DataName="DSSupporter_";
	var ChangeLogDataName='Supporter';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSSupporter_Edit","70","Admin.Supporter.Edit",""],
					["لیست تغییرات","DSChangeLog","95","Admin.Supporter.ChangeLog.List","ChangeLogDataName=Supporter"]
					];
	//=======Form1 Supporter Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={	MaxUser:'Max Huser available of this Supporter(Limit how many Huser will be add)',
	...
	var Form1FieldHelpId=["UsernamePattern"];
	var Form1TitleField="SupporterName";
	...
	var Form1Str = [
		{ type:"settings" , labelWidth:187, inputWidth:250,offsetLeft:10  },
		{ type: "label"},
		{ type:"hidden" , name:"Supporter_Id", label:"شناسه پشتیبان :",disabled:"true", labelAlign:"left", inputWidth:130},
		...
		{ type:"input" , name:"SupporterName", label:"نام پشتیبان :",maxLength:64, validate:"NotEmpty",required:true, labelAlign:"left", info:"true", inputWidth:300},
		{ type: "select", name:"Reseller_Id",label: "نماینده فروش :",connector: TabbarMainArray[0][1]+"Render.php?"+un()+"&act=SelectReseller&id="+RowId,inputWidth:150},
		{ type:"input" , name:"PerPortDailyCF", label:"فرمول پورسانت روزانه به ازای پورت :",validate:"IsValidSupporterFormula",value:"0,0", labelAlign:"left", info:"true", inputWidth:200,required:true},
		{ type:"input" , name:"PerPaymentCF", label:"فرمول پورسانت به ازای  پرداخت :",validate:"IsValidCommissionFormula", labelAlign:"left", value:"0,0",info:"true", inputWidth:200,required:true},
	...
	ISPermitView=ISPermit("Admin.Supporter.View");
	ISPermitEdit=ISPermit("Admin.Supporter.Edit");
	ISPermitAdd=ISPermit("Admin.Supporter.Add");
