...
DSDebug(1,"DSReseller_MyCredit_ListRender.........................................................................");
PrintInputGetPost();
if($LResellerName==""){
...
exitifnotpermit(0,"CRM.MyCredit.List");
...
switch ($act) {
    case "list":
				DSDebug(0,"DSReseller_MyCredit_ListRender->Filter********************************************");
				
				$FieldsItems=Array(
					Array("Hrc.Reseller_Credit_Id","Hrc.Comment"),
					Array("Hrc.Credit","Hrc.Price"),
					Array("Hrc.CreditType")
				);				
				...
				$WhereStr="((Hrc.From_Reseller_Id=$LReseller_Id)Or(Hrc.To_Reseller_Id=$LReseller_Id))";
				...
				elseif(($req=="ShowInGrid")or($req=="SaveToFile")){		
					...
					if($req=="SaveToFile"){
						...
						header('Content-Disposition: attachment; charset=utf-8; filename="MyCredit.csv";');
						$res = $conn->sql->query($sql);
						$data =  $conn->sql->get_next($res);
