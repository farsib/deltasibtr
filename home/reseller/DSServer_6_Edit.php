...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="سامانه شکایات و پیشنهادات پنل";
	var DataName="DSServer_6_";
	var ChangeLogDataName='Server';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSServer_6_Edit","70","Admin.Server.WebNewUser.Edit",""],
	...
	var Form1FieldHelpId=["CompanyCode"];
	...
	var Form1Str = [
		...
		{ type: "select", name:"IsEnableFeedback", label: "فعال :", options:[{text: "بلی", value: "Yes",selected: true},{text: "خیر", value: "No"}],inputWidth:80,required:true},
		{type:"block",name:"BodyBlock",width:600,list:[
			{ type:"settings" , labelWidth:150, inputWidth:250,offsetLeft:10  },
			{ type: "input" , name:"CompanyCode", label:"کد شرکت :", validate:"NotEmpty",maxLength:8,inputWidth:82,required:true},
		]}
		];
...
function Form1DoAfterLoadOk(){
	...
	if(Form1.getItemValue("IsEnableFeedback")=="Yes")
		Form1.enableItem("BodyBlock");
	else
		Form1.disableItem("BodyBlock");
}	
