...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="دسته";
	var DataName="DSClass_";
	var ChangeLogDataName='Class';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSClass_Edit","70","Admin.User.Class.Edit",""],
					["پارامتر","DSParam_List","80","Admin.User.Class.Param.List","ParamItemGroup=Class"],
					["دسترسی نماینده","DSClass_ResellerAccess_List","130","Admin.User.Class.ResellerAccess.List",""],
					["دسترسی ارائه دهنده مجازی اینترنت","DSClass_VispAccess_List","200","Admin.User.Class.VispAccess.List",""],
					["لیست تغییرات","DSChangeLog","95","Admin.User.Class.ChangeLog.List","ChangeLogDataName=Class"]
					];
	//=======Form1 Visp Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={	ClassName:'حداکثر ۳۲ کاراکتر',
							};
	var Form1FieldHelpId=["ClassName"];
	var Form1TitleField="ClassName";
	var Form1DisableItems=["ClassName"];
	...
	var Form1Str = [
		...
		{ type: "label"},
		{ type:"hidden" , name:"Class_Id", label:"شناسه دسته :",disabled:"true", labelAlign:"left", inputWidth:130},
		...
		{ type:"input" , name:"ClassName", label:"نام دسته :",maxLength:32, validate:"NotEmpty",required:true, labelAlign:"left", info:"true", inputWidth:200}
		];
	
	var PermitView=ISPermit("Admin.User.Class.View");
	var PermitAdd=ISPermit("Admin.User.Class.Add");
	var PermitEdit=ISPermit("Admin.User.Class.Edit");
	var PermitDelete=ISPermit("Admin.User.Class.Delete");
