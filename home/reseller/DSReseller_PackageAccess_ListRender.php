...
DSDebug(0,"DSReseller_PackageAccess_ListRender ..............................................................................");
...
$Table2='Hpackage';
$Table2_IdName='Package_Id';
$Table2_TextFieldName='PackageName';

$Table3='Hreseller_packageaccess';



$act=Get_Input('GET','DB','act','ARRAY',array("list","do"),0,0,0);
$Table1_Id=Get_Input('GET','DB','ParentId','INT',1,4294967295,0,0);
if($Table1_Id==$LReseller_Id)
...
if($act=='do'){//request for CHANGE
	...
	exitifnotpermit(0,"CRM.Reseller.{$Item}.Edit");
