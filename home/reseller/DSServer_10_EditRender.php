...
DSDebug(1,"DSServer_4_EditRender ..................................................................................");

if($LResellerName=='') 	ExitError('نشست منقضی شده، لطفا مجدد وارد شوید');
PrintInputGetPost();

if(class_exists("SOAPClient")==false)
	ExitError("نصب نشده است php-soap");
...
switch ($act) {
    case "load":
				DSDebug(1,"DSServer_4_EditRender Load ********************************************");
				exitifnotpermit(0,"Admin.Server.BackupWebAccess.View");
				$Server_Id=Get_Input('GET','DB','id','INT',1,4294967295,0,0);
				$sql="SELECT '' As Error,Server_Id,PartName,Param1 As ISEnable,Param2 As Port,Param3 as PermitIP from Hserver where Server_Id='$Server_Id'";
       ...
       break;
    case "update":
				DSDebug(1,"DSServer_4_EditRender Update ******************************************");
				exitifnotpermit(0,"Admin.Server.BackupWebAccess.Edit");
				$NewRowInfo=array();
				...
				$NewRowInfo['Param2']=Get_Input('POST','DB','Port','INT',1,65535,0,0);
				if($NewRowInfo['Param2']==$_SERVER["SERVER_PORT"])
					ExitError("نمی توان از پورت استفاده کرد ".$_SERVER["SERVER_PORT"].". آن برای دلتاسیب استفاده شده ");
				$NewRowInfo['Param3']=Get_Input('POST','DB','PermitIP','STR',1,250,0,0);
				...
				*/
				...
				$res=runshellcommand("php","DSSetWebServWebAccess","","");
				DSDebug(0,"Result=[$res]");
				echo "OK~";
