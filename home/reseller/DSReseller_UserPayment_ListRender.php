...
DSDebug(1,"DSReseller_UserPayment_ListRender.........................................................................");
PrintInputGetPost();
if($LResellerName==""){
...
exitifnotpermit(0,"CRM.UserPayment.List");

$act=Get_Input('GET','DB','act','ARRAY',array(
    "list",
    "SelectReseller",
    "SelectResellerAndOperators"
    ),0,0,0);
...
switch ($act) {
    case "list":
				DSDebug(0,"DSReseller_UserPayment_ListRender->Filter********************************************");				
				$FieldsItems=Array(
					...
					Array("Hup.VoucherNo","Hup.BankBranchNo","Hup.BankBranchName","Hup.Comment"),
					Array("Hup.PaymentType","Hup.Charger_Id","Hup.Reseller_Id","Hup.Supporter_Id")
				);				

				$GroupByArray=Array(
					"GroupByOn" => Array("left(SHDATESTR(Hup.User_PaymentCDT),4)","left(SHDATESTR(Hup.User_PaymentCDT),7)","left(SHDATESTR(Hup.User_PaymentCDT),10)","Hu.Visp_Id","Hu.Center_Id","Hu.Reseller_Id","Hu.Supporter_Id","Hup.Charger_Id","Hup.Reseller_Id","Hup.Supporter_Id"),
					"GroupByValue" => Array("left(SHDATESTR(Hup.User_PaymentCDT),4)","left(SHDATESTR(Hup.User_PaymentCDT),7)","left(SHDATESTR(Hup.User_PaymentCDT),10)","Hv.VispName","Hc.CenterName","Hr.ResellerName","Hsu.SupporterName","Hrcharger.ResellerName","HrReseller.ResellerName","HrSupporter.ResellerName"),
					"GroupByTitle" => Array("YearOfCreate","MonthOfCreate","DayOfCreate","UserVisp","UserCenter","UserReseller","UserSupporter","PaymentCharger","PaymentReseller","PaymentSupporter")
				);
				...
				$WhereStr="(Hup.Creator_Id=$LReseller_Id OR Hup.Charger_Id=$LReseller_Id)";
				...
				elseif(($req=="ShowInGrid")or($req=="SaveToFile")){		
					...
					if($ChkStatus){
						...
						if($ChkStatus){
							$FieldIndex=Get_Input('GET','DB','GroupBy'.$i,'INT',0,10,0,0);
    ...
    case "SelectReseller":
        ...
        break;      
     case "SelectResellerAndOperators":
							require_once('../../lib/connector/options_connector.php');
							$options = new SelectOptionsConnector($mysqli,"MySQLi");
							$sql="SELECT '' as Reseller_Id,'' as ResellerName union ".
