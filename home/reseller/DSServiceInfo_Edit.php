...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="اطلاعات سرویس";
	var DataName="DSServiceInfo_";
	var ChangeLogDataName='ServiceInfo';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSServiceInfo_Edit","70","Admin.User.ServiceInfo.Edit",""],
					["لیست تغییرات","DSChangeLog","95","Admin.User.ServiceInfo.ChangeLog.List","ChangeLogDataName=ServiceInfo"]
					];
	//=======Form1 ServiceInfo Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={ServiceInfoName:'Name refer to these rate(Engish,32 char, Not editable)'};
	var Form1FieldHelpId=["ServiceInfoName"];
	var Form1TitleField="ServiceInfoName";
	var Form1DisableItems=["ServiceInfoName"];
	...
	var Form1Str = [
		{ type:"settings" , labelWidth:85, inputWidth:250,offsetLeft:10  },
		{ type: "label"},
		{ type:"hidden" , name:"ServiceInfo_Id", label:"ServiceInfo_Id :",disabled:"true", labelAlign:"left", inputWidth:130},
		{ type:"input" , name:"ServiceInfoName", label:"نام :",maxLength:32, validate:"NotEmpty,IsValidENName",required:true, labelAlign:"left", info:"true", inputWidth:150},
		{ type:"input" , name:"ServiceInfoValue", label:"Value :",maxLength:16, validate:"NotEmpty",required:true, labelAlign:"left", inputWidth:300},
		{ type:"input" , name:"ServiceRate", label:"ServiceRate :",maxLength:16, validate:"NotEmpty",required:true, labelAlign:"left", inputWidth:300}
		];
	...
	if(RowId==1)
		Form1.disableItem("ServiceInfoValue");
