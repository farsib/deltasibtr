...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="قانون اتمام";
	var DataName="DSFinishRule_";
	var ChangeLogDataName='FinishRule';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSFinishRule_Edit","70","Admin.User.FinishRule.Edit",""],
					["لیست تغییرات","DSChangeLog","95","Admin.User.FinishRule.ChangeLog.List","ChangeLogDataName=FinishRule"]
					];
	//=======Form1 FinishRule Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={FinishRuleName:'حداکثر ۳۲ کاراکتر'};
	var Form1FieldHelpId=["FinishRuleName"];
	var Form1TitleField="FinishRuleName";
	var Form1DisableItems=["FinishRuleName"];
	...
	var Form1Str = [
		...
		{ type: "label"},
		{ type:"hidden" , name:"FinishRule_Id", label:"FinishRule_Id :",disabled:"true", labelAlign:"left", inputWidth:130},
		{ type:"input" , name:"FinishRuleName", label:"نام :",maxLength:32, validate:"NotEmpty,IsValidENName",required:true, labelAlign:"left", info:"true", inputWidth:200},
		{type: "select", name:"OnActiveServiceExpirePool_Id",label: "دامنه آی پی زمان انقضا سرویس:",connector: "DSFinishRule_EditRender.php?act=SelectIPPool",required:true,inputWidth:200},
		{type: "select", name:"OnTrafficFinishPool_Id",label: "دامنه آی پی زمان اتمام ترافیک:",connector: "DSFinishRule_EditRender.php?act=SelectIPPool",required:true,inputWidth:200},
		{type: "select", name:"OnTimeFinishPool_Id",label: "دامنه آی پی زمان اتمام زمان:",connector: "DSFinishRule_EditRender.php?act=SelectIPPool",required:true,inputWidth:200},
		{type: "select", name:"OnDebitFinishPool_Id",label: "دامنه آی پی زمان کنترل بدهی:",connector: "DSFinishRule_EditRender.php?act=SelectIPPool",required:true,inputWidth:200},
		];
 	 	 	 	 	 
	var PermitView=ISPermit("Admin.User.FinishRule.View");
	var PermitAdd=ISPermit("Admin.User.FinishRule.Add");
	var PermitEdit=ISPermit("Admin.User.FinishRule.Edit");
	var PermitDelete=ISPermit("Admin.User.FinishRule.Delete");
