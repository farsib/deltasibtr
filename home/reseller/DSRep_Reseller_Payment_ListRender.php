...
DSDebug(1,"DSRep_Reseller_Payment_ListRender.........................................................................");
PrintInputGetPost();
if($LResellerName==""){
...
exitifnotpermit(0,"Report.Reseller.Payment.List");
...
switch ($act) {
    case "list":
				DSDebug(0,"DSRep_Reseller_Payment_ListRender->Filter********************************************");
				$FieldsItems=Array(
					...
					Array("Hrp.PaymentType","Hrp.Creator_Id","Hrp.Reseller_Id")
				);				

				$GroupByArray=Array(
					"GroupByOn" => Array("left(SHDATESTR(Hrp.Reseller_PaymentCDT),4)","left(SHDATESTR(Hrp.Reseller_PaymentCDT),7)","left(SHDATESTR(Hrp.Reseller_PaymentCDT),10)","Hrp.Creator_Id","Hrp.Reseller_Id","Hrp.PaymentType"),
					"GroupByValue" => Array("left(SHDATESTR(Hrp.Reseller_PaymentCDT),4)","left(SHDATESTR(Hrp.Reseller_PaymentCDT),7)","left(SHDATESTR(Hrp.Reseller_PaymentCDT),10)","rc.ResellerName","r.ResellerName","Hrp.PaymentType"),
					"GroupByTitle" => Array("YearOfCreate","MonthOfCreate","DayOfCreate","Creator","Reseller","PaymentType")
				);
				...
				$WhereStr="(Hrp.PaymentType<>'Initial')";
				...
				if($req=="GetRecordCount"){
					$sql="select count(1) from Hreseller_payment Hrp ".
						"join Hreseller r on $MyResellerAccess and Hrp.Reseller_Id=r.Reseller_Id ".
						"where $WhereStr";
				...
				elseif(($req=="ShowInGrid")or($req=="SaveToFile")){		
					...
					if($ChkStatus){
						...
						$SelectStr="Hrp.Reseller_Payment_Id,rc.ResellerName as Creator,r.Resellername as Reseller".
						...
						$ColumnStr="Reseller_Payment_Id,Creator,Reseller,PaymentCDT,PaymentType,Price,VoucherNo,VoucherDate,BankBranchName,BankBranchNo,Comment";
					}
