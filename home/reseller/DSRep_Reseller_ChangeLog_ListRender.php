...
DSDebug(1,"DSRep_Reseller_ChangeLog_ListRender.........................................................................");
PrintInputGetPost();
if($LResellerName==""){
...
exitifnotpermit(0,"Report.Reseller.ChangeLog.List");
...
switch ($act) {
    case "list":
				DSDebug(0,"DSRep_Reseller_ChangeLog_ListRender->Filter********************************************");
				$FieldsItems=Array(
				...
				if($LReseller_Id==1)
					$WhereStr="1";
				elseif($LISManager=='Yes')
					$WhereStr=$LResellerAccessAllow;
				else
					$WhereStr="(r.Reseller_Id=$LReseller_Id or $LResellerAccessAllow)";
				...
				if($req=="GetRecordCount"){
					$sql="select count(1) from Hlogdb Hldb ".
						"join Hreseller r on Hldb.Reseller_Id=r.Reseller_Id ".
						"where $WhereStr";
