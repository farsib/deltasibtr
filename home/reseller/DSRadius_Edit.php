...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="پورت ها";
	var DataName="DSRadius_";
	var ChangeLogDataName='Radius';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSRadius_Edit","70","Admin.Radius.Edit",""],
					["دسترسی ردیوس","DSRadius_NasAccess_List","120","Admin.Radius.NasAccess.List",""],
					["لیست تغییرات","DSChangeLog","95","Admin.Radius.ChangeLog.List","ChangeLogDataName=Radius"],
					];
	//=======Form1 Radius Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={	RadiusType:'Type of packets to listen for',
							AuthPort:'Port on which to listen',
							AcctPort:'Port on which to listen'};
	var Form1FieldHelpId=["RadiusType","Port"];
	var Form1TitleField="RadiusName";
	var Form1DisableItems=[];
	var Form1EnableItems=[];
	var Form1HideItems=[];
	var Form1ShowItems=[];
	var Form1FocusItemAdd="RadiusName";

	var Form1Str = [
		{ type:"settings" , labelWidth:170, inputWidth:250,offsetLeft:10  },
		{ type: "label"},
		{ type:"hidden" , name:"Radius_Id", label:"شناسه ردیوس :",disabled:"true", labelAlign:"left", inputWidth:130},
		{ type: "select", name:"ISEnable", label: "فعال :", options:[{text: "بلی", value: "Yes",selected: true},{text: "خیر", value: "No"}],inputWidth:80,info:"true",required:true},
		{ type:"input" , name:"RadiusName", label:"نام پورت :",maxLength:32, validate:"NotEmpty,IsValidENName",required:true, labelAlign:"left", inputWidth:150},
		{ type:"input" , name:"AuthPort", label:"پورت تصدیق :",maxLength:5,value:"1812", validate:"NotEmpty,ValidInteger",required:true, labelAlign:"left", info:"true", inputWidth:60},
		{ type:"input" , name:"AcctPort", label:"پورت حسابداری :",maxLength:5,value:"1813", validate:"NotEmpty,ValidInteger",required:true, labelAlign:"left", info:"true", inputWidth:60},
		];

	var PermitView=ISPermit("Admin.Radius.View");
	var PermitAdd=ISPermit("Admin.Radius.Add");
	var PermitEdit=ISPermit("Admin.Radius.Edit");
	var PermitDelete=ISPermit("Admin.Radius.Delete");
	...
	if(RowId>0){
		...
		if(PermitEdit)	DSToolbarAddButton(Toolbar1,null,"Save","فعال","tof_Save",Toolbar1_OnSaveClick);
