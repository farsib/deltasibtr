...
DSDebug(1,"DSRep_User_Attachment_ListRender.........................................................................");
...
exitifnotpermit(0,"Report.User.Attachment.List");

$act=Get_Input('GET','DB','act','ARRAY',array("list","ViewAttachment"),0,0,0);

switch ($act) {
    case "list":
				DSDebug(0,"DSRep_User_Attachment_ListRender->List ********************************************");
				...
				function color_rows($row){
					...
					$row->set_cell_style("RealFilename","font-weight:Bold;background-color:lightblue;".$RowFormat);
				...
				$VispUserAttachmentList=DBSelectAsString("Select PermitItem_Id from Hpermititem where PermitItemName='Visp.User.Attachment.List'");				
				...
				$sql="select $SelectStr from UserAttachmentTemp UAT ".
					(($LReseller_Id!=1)?"join Hreseller_permit Hrp1 on Hrp1.Reseller_Id=$LReseller_Id and Hrp1.Visp_Id=UAT.Visp_Id and Hrp1.PermitItem_Id=$VispUserList and Hrp1.ISPermit='Yes' ".
					"join Hreseller_permit Hrp2 on Hrp2.Reseller_Id=$LReseller_Id and Hrp2.Visp_Id=UAT.Visp_Id and Hrp2.PermitItem_Id=$VispUserAttachmentList and Hrp2.ISPermit='Yes' ":"").
