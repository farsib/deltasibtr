...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="نام سرویس/آی پی سرور";
	var DataName="DSCalledId_";
	var ChangeLogDataName='CalledId';
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSCalledId_Edit","70","Admin.CalledId.Edit",""],
					["لیست تغییرات","DSChangeLog","95","Admin.CalledId.ChangeLog.List","ChangeLogDataName=CalledId"]
					];
	//=======Form1 CalledId Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={CalledIdName:'انگلیسی - ۳۲ کاراکتر - غیرقابل ویرایش پس از ذخیره'};
	var Form1FieldHelpId=["CalledIdName"];
	var Form1TitleField="CalledIdName";
	var Form1DisableItems=["CalledIdName"];
	...
	var Form1Str = [
		...
		{ type: "label"},
		{ type:"hidden" , name:"CalledId_Id", label:"CalledId_Id :",disabled:"true", labelAlign:"left", inputWidth:130},
		{ type:"input" , name:"CalledIdName", label:"نام :",maxLength:32, validate:"NotEmpty,IsValidENName",required:true, labelAlign:"left", info:"true", inputWidth:150},
		{ type:"input" , name:"CalledIdValue", label:"مقدار :",maxLength:50, validate:"", labelAlign:"left", inputWidth:300,note:{text:"<span style='direction:rtl;float:right;'>می توانید با استفاده از کاما (,) به عنوان جداکننده موردهای بیشتری را وارد کنید<br/>برای عدم محدودیت،خالی یگذارید</span>"}}
		];

	var PermitView=ISPermit("Admin.CalledId.View");
	var PermitAdd=ISPermit("Admin.CalledId.Add");
	var PermitEdit=ISPermit("Admin.CalledId.Edit");
