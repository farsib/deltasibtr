...
window.onload = function(){
	...
	if(RowId == "" ) {return;}
	var DataTitle="مورد پشتیبانی";
	var DataName="DSSupportItem_";
	var TabbarMain,TopToolbar;
	//=======TabbarMain
	var TabbarMainArray=[
					["اطلاعات","DSSupportItem_Edit","70","Admin.User.SupportItem.Edit",""],
					["لیست تغییرات","DSChangeLog","95","Admin.User.SupportItem.ChangeLog.List","ChangeLogDataName=SupportItem"]
	];
	//=======Form1 Gift Info
	var Form1;
	var Form1PopupHelp;
	var Form1FieldHelp  ={SupportItemTitle:""};
	var Form1FieldHelpId=["SupportItemTitle"];
	var Form1TitleField="SupportItemTitle";
	var Form1DisableItems=[""];
	var Form1EnableItems=[];
	var Form1HideItems=[];
	var Form1ShowItems=[];
	var Form1FocusItemAdd="SupportItemTitle";
	...
	var Form1Str = [
		...
		{ type: "label"},
		{ type:"hidden" , name:"SupportItem_Id", label:"SupportItem_Id :",disabled:"true", labelAlign:"left", inputWidth:120},
		{ type: "select", name:"IsEnable", label: "فعال ؟ :", options:[{text: "بلی", value: "Yes",selected: true},{text: "خیر", value: "No"}],inputWidth:120,required:true},
		{ type:"input" , name:"SupportItemTitle", label:"عنوان مورد پشتیبانی :",maxLength:64, validate:"NotEmpty",required:true, labelAlign:"left", inputWidth:350}
	];
