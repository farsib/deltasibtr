...
DSDebug(1,"DSServer_7_EditRender ..................................................................................");
...
switch ($act) {
    case "load":
				DSDebug(1,"DSServer_7_EditRender Load ********************************************");
				exitifnotpermit(0,"Admin.Server.GeneralNoneBlockIP.View");
				$Server_Id=Get_Input('GET','DB','id','INT',1,4294967295,0,0);
				$sql="SELECT '' As Error,Server_Id,PartName,Param1 As BruteForceNoneBlockIP,Param2 As UserPasswordWrongNoneBlockIP ".
       ...
       break;
    case "update":
				DSDebug(1,"DSServer_7_EditRender Update ******************************************");
				exitifnotpermit(0,"Admin.Server.GeneralNoneBlockIP.Edit");
				$NewRowInfo=array();
				$NewRowInfo['Server_Id']=Get_Input('POST','DB','Server_Id','INT',1,4294967295,0,0);
				$NewRowInfo['Param1']=Get_Input('POST','DB','BruteForceNoneBlockIP','STR',0,250,0,0);
				$NewRowInfo['Param2']=Get_Input('POST','DB','UserPasswordWrongNoneBlockIP','STR',0,250,0,0);
